...
void AccelStepper::step1(uint8_t step)
{
  ...
  setOutputPins((_speed > 0) ? B(11) : B(01)); // step HIGH
    // Caution 200ns setup time 
    // Delay the minimum allowed pulse width
    delayMicroseconds(_minPulseWidth);
    setOutputPins((_speed > 0) ? B(10) : B(00)); // step LOW
...
void AccelStepper::step4(uint8_t step)
{
    ...
    {
	case 0:    // 1010
	  setOutputPins(B(0101));
	    break;

	case 1:    // 0110
	  setOutputPins(B(0110));
	    break;

	case 2:    //0101
	  setOutputPins(B(1010));
	    break;

	case 3:    //1001
	  setOutputPins(B(1001));
	    break;
    }
}
